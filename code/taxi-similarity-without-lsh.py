...
def measure_time_used_to_run_notebook(path_to_notebook, output_path):
    ...
    FOLDERS_TO_EMPTY = [f"data/bus_data", f"data/chosen_data/{global_variables.CHOSEN_SUBSET_NAME}", f"code/experiments/results/{global_variables.CHOSEN_SUBSET_NAME}/lists", f"code/experiments/results/{global_variables.CHOSEN_SUBSET_NAME}/plots"]
...
if __name__=="__main__":
    path_to_notebook = "code/taxi-similarity-without-lsh.ipynb"
    output_path = "code/experiments/timing/"
    #change this name depending on what type of run is done
    output_file_name = "datset-2500-without-LSH.txt"
