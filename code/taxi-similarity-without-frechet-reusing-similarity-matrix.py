...
if __name__=="__main__":
    path_to_notebook = "code/taxi-similarity-without-frechet-reusing-similarity-matrix.ipynb"
    output_path = "code/experiments/timing/"
    #change this name depending on what type of run is done
    output_file_name = "datset-2500-without-Frechet-to-find-well-used-routes-reusing-similarity-matrix.txt"
